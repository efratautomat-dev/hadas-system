...
| 2026-07-28 | Invoices.tsx | Credit note mis-classified as a charge was stored positive and inflated the supplier balance, with no way to correct it; editing amounts by hand left `invoice_type` stale and could double-negate | fixed — "סמן כזיכוי" action + `lib/creditNote.ts`, see `06-RULES.md §2c` |
