import { PDF_BASE_CSS, PDF_BRAND, PDF_BRAND_LIGHT, getPdfLogoUrl, fmtILS, todayHebrew, escHtml, openPrintWindow } from './pdfConfig'
...
<head>
  ...
  <style>
    ...
    .tbl thead tr { background: ${PDF_BRAND}; }
    ...
    .tbl tfoot tr td { background: ${PDF_BRAND_LIGHT}; font-weight: 700; border-top: 2px solid ${PDF_BRAND}; }
    ...
    <table class="tbl">
      ...
      <tfoot>
        <tr>
          ...
          <td class="num" style="color:${PDF_BRAND};font-size:14px">${fmtILS(runningBalance)}</td>
        </tr>
      </tfoot>
    </table>
  </div>`
